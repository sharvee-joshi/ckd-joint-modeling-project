...
|-------------|---------------|
| **Sharvee** | GitHub repository setup and organization, exploratory data analysis (EDA), missingness summaries, abstract writing, and drafting the joint modeling framework section of the report. |
